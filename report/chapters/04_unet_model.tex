...
\begin{itemize}
    ...
    \item The voxel shape must be divisible by a factor $k$. This is enforced by:\\
        \texttt{DivisiblePadd(keys=["image", "label"], k=16)}
\end{itemize}
